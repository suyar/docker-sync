...
MAPPINGS = {
    ...
    "nginx-1.28": {"workflow": ".github/workflows/sync-nginx.yml", "style": "track_minor_full", "track": "1.28"},
    "nginx-1.30": {"workflow": ".github/workflows/sync-nginx.yml", "style": "track_minor_full", "track": "1.30"},
